...
TEST_CASE("test no sides fixed"){
    ...
    result1Elements.insert(std::pair<ProgramElement, ProgramElement>(ProgramElement::createStatement(ElementType::PRINT, 11, "x"),
                                                                     ProgramElement::createStatement(ElementType::PRINT, 11, "x")));
    ...
    result2Elements.insert(std::pair<ProgramElement, ProgramElement>(ProgramElement::createStatement(ElementType::READ, 5, "x"),
                                                                     ProgramElement::createStatement(ElementType::PRINT, 11, "x")));
