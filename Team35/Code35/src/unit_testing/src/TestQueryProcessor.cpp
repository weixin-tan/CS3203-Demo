...
TEST_CASE("trippy queries"){
  ...
  string s24 = "assign and; while while; Select and such that Parent* (while, and) with while.stmt# = and.stmt# pattern and (\"x\", _)";
  string s25 =   "assign pattern; while with; Select pattern such that Parent* (with, pattern) with with.stmt# = pattern.stmt# and pattern.stmt# = 1 pattern pattern (\"pattern\", _) ";
  string s26 = "assign such; while that; Select such such that Parent* (that, such) with that.stmt# = such.stmt# pattern such (\"x\", _)";

  string s27 = "assign Select; Select Select with Select.stmt# = 12 and Select.stmt# = 13 pattern Select (\"Select\", _)";
  ...
  string s31 = "assign pattern; Select pattern with pattern.stmt# = 12 and pattern.stmt# = 13 pattern pattern (\"pattern\", _)";
  ...
  string s37 = "stmt pattern;Select pattern with pattern.stmt# = 12 such that Next* (1, pattern) and Next* (pattern, 3)";
...
TEST_CASE("test advanced queries"){
  ...
  string s9 = "assign a; while w; if ifs; Select a pattern a (\"pattern\", _) and w (\"pattern\", _) pattern ifs (\"pattern\", _, _)";
  string s10 = "assign a; while w; if ifs; Select a pattern a (\"pattern\", _) and w (\"pattern\", _) and ifs (\"pattern\", _, _)";
  ...
  string s14 = "stmt s; assign a, a1; Select a with a.stmt# = 1 and a1.stmt# = 3 pattern a (\"pattern\", _) such that Next* (1, s)";
  string s15 = "stmt s; assign a, a1; while w; Select s with a1.stmt# = 3 such that Next* (1, s) and Next* (s, 3) pattern w (\"pattern\", _)";
  string s16 =  "stmt s; assign a, a1; while w; if ifs; Select a with 1 = 3 pattern w (\"pattern\", _) and ifs (\"pattern\", _, _) such that Follows*(1,3) ";
