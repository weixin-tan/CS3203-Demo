...
class QueryProcessor {
 ...
 private:
  ...
  static Entity findRelationshipEntityWithAttribute(const std::string &s,  std::unordered_map<std::string, Entity>* entityMap);
  static RelationshipRef createWithObject(std::vector<std::string> clauseList, std::unordered_map<std::string, Entity>* entityMap);
};
